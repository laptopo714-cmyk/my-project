...
export const ClipboardListIcon: React.FC = () => (
  <svg {...iconProps} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h.01M15 12h.01M10.5 16.5h3m-6.38 1.51L6.62 19.5l-1.12-1.12a.75.75 0 010-1.061l1.12-1.12a.75.75 0 011.06 0l1.12 1.12a.75.75 0 010 1.061zM16.5 16.5h3m-3.38 1.51l-.5 1.5-1.12-1.12a.75.75 0 010-1.061l1.12-1.12a.75.75 0 011.06 0l1.12 1.12a.75.75 0 010 1.061zM21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
  </svg>
);
...
export const PlusIcon: React.FC<{className?: string}> = ({className}) => (
  <svg {...iconProps} className={className || iconProps.className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const LogoutIcon: React.FC<{className?: string}> = ({className}) => (
    <svg {...iconProps} className={className || "w-5 h-5"} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const YoutubeIcon: React.FC = () => (
    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        <path fillRule="evenodd" d="M19.812 5.418c.861.23 1.538.907 1.768 1.768C21.998 8.78 22 12 22 12s0 3.22-.42 4.814a2.506 2.506 0 0 1-1.768 1.768c-1.594.42-7.812.42-7.812.42s-6.218 0-7.812-.42a2.506 2.506 0 0 1-1.768-1.768C2 15.22 2 12 2 12s0-3.22.42-4.814a2.506 2.506 0 0 1 1.768-1.768C5.782 5 12 5 12 5s6.218 0 7.812.418ZM9.937 15.545V8.455l6.109 3.545-6.109 3.545z" clipRule="evenodd" />
    </svg>
);

export const TelegramIcon: React.FC = () => (
    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        <path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.17.91-.494 1.208-.822 1.23-.696.047-1.225-.46-1.9-1.002-1.056-.8-1.66-1.29-2.6-2.04-.992-.795-1.785-1.59-1.507-2.52.02-.075.05-.15.085-.224.28-.59 5.022-4.51 5.31-4.85.024-.03.04-.05.056-.07.03-.03.014-.09-.033-.122-.047-.032-.122-.024-.202-.002-.09.024-.19.055-2.07 1.33-2.31 1.56-2.81 1.83-3.21 1.82-.48-.01-1.256-.24-1.84-.44-.71-.24-1.25-.37-1.18-.74.05-.28.32-.53.74-.75 2.13-1.09 3.94-1.88 5.4-2.53 2.1-.92 2.74-1.13 3.12-1.14z" />
    </svg>
);
...
export const AcademicCapIcon: React.FC = () => (
    <svg {...iconProps} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path d="M3 13.6621C3 14.2256 3.2985 14.7573 3.79152 15.0682L10.7915 19.5682C11.5395 20.062 12.4605 20.062 13.2085 19.5682L20.2085 15.0682C20.7015 14.7573 21 14.2256 21 13.6621V10.3379C21 9.77443 20.7015 9.24273 20.2085 8.93183L13.2085 4.43183C12.4605 3.93803 11.5395 3.93803 10.7915 4.43183L3.79152 8.93183C3.2985 9.24273 3 9.77443 3 10.3379V13.6621Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/>
        <path d="M22 9L12 14L2 9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M17 12.5V15.5C17 16.6046 16.1046 17.5 15 17.5H9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
);
...
export const WhatsappIcon: React.FC = () => (
     <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        <path d="M12.04 2C6.58 2 2.13 6.45 2.13 12c0 1.74.45 3.48 1.34 5l-1.4 5.13 5.26-1.38c1.45.81 3.12 1.25 4.71 1.25h.01c5.46 0 9.91-4.45 9.91-9.91 0-5.46-4.45-9.9-9.91-9.9zm4.33 12.83c-.19.53-.78 1-1.35 1.18-.46.14-1.03.2-1.63-.04-.69-.28-1.5-.7-2.17-1.3-.8-.74-1.6-1.68-2.22-2.75-.54-.92-.85-1.95-.83-2.98.02-.82.26-1.52.7-2.02.48-.55 1.1-.73 1.5-.73.21 0 .42.03.62.08.48.12.7.58.82 1.25.12.67.04 1.4-.08 2.05-.13.65-.28 1.23-.08 1.78.19.55.69.98 1.18 1.13.58.18 1.16.1 1.68-.08.5-.18 1.03-.5 1.03-1.1s-.2-1.3-.4-1.85c-.2-.55-.41-1.1-.08-1.58.33-.48.98-.75 1.63-.68.65.08 1.1.43 1.35.98.25.55.25 1.78-.38 2.98-.63 1.2-1.95 2.04-2.2 2.18z" />
    </svg>
);
...
export const UserGroupIcon: React.FC = () => (
    <svg {...iconProps} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.57-1.023 1.535-1.85 2.662-2.345m-2.662 2.345a3 3 0 11-5.884 2.662 3 3 0 015.884-2.662m2.662 2.345L15 14.973m-3.847-5.92c0-1.591 1.29-2.881 2.88-2.881s2.88 1.29 2.88 2.881c0 1.591-1.29 2.88-2.88 2.88s-2.88-1.29-2.88-2.88zm0 0c0-1.591-1.29-2.881-2.88-2.881S3.12 4.66 3.12 6.251c0 1.591 1.29 2.88 2.88 2.88s2.88-1.29 2.88-2.88z" />
    </svg>
);
